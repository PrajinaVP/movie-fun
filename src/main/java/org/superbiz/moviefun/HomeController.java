...
public class HomeController {
    ...
    public String setup(Map<String, Object> model) {
        new TransactionTemplate(moviesTransactionManager).execute(new TransactionCallback<Object>() {
            @Override
        ...
        new TransactionTemplate(albumsTransactionManager).execute(new TransactionCallback<Object>() {
            @Override
            public Object doInTransaction(TransactionStatus transactionStatus) {
